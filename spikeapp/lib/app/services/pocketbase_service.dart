...
import 'package:spikeapp/app/data/helper.dart';
import 'package:spikeapp/app/data/message_builder.dart';
import 'package:spikeapp/app/models/chat_room.dart';
import 'package:spikeapp/app/models/user.dart';
...
class PocketbaseService extends GetxService {
  ...
  final _pocketBaseUrl = "https://spikestone.site";
